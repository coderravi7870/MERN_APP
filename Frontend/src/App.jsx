...
export default function App() {
  ...
  const handleRunFlow = async () => {
    ...
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/ask-ai`, {
        prompt,
      });
      ...
      const msg =
        ...
        "Failed to get AI response. Check your API key.";
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="text-xs px-3 py-1.5 rounded-lg text-gray-400 hover:text-white transition-colors flex items-center gap-2"
